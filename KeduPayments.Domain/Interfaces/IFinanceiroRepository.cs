...
{
    /// <summary>
    /// Interface para o repositório financeiro, definindo os métodos para operações CRUD.
    /// </summary>
    public interface IFinanceiroRepository
    {
        ...
        /// <returns></returns>
        Task<Pagamento> AdicionarPagamentoPorCobranca(Pagamento pagamento);
        ...
        /// <returns></returns>
        Task<Cobranca> AtualizarStatusCobranca(int id, string? status, decimal? valor);
        
        /// <summary>
        /// Método para obter uma cobrança pelo seu ID.
        /// </summary>
        /// <param name="id">ID da cobrança a ser obtida.</param>
        Task<Cobranca?> ObterCobranca(int id);
        ...
        Task<ICollection<Cobranca>> ObterCobrancasPorResponsavel(int responsavelId, string? status, int? metodoPagamento,
        ...
        /// <returns></returns>
        Task<PlanoPagamento> AdicionarPlanoPagamento(PlanoPagamento planoPagamento);
        ...
        Task<PlanoPagamento> ObterPlanoPagamento(int id);
        ...
        Task<IEnumerable<PlanoPagamento>> ObterPlanosPagamentoPorResponsavel(int responsavelId);
